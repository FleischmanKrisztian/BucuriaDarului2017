...
namespace BucuriaDarului.Web.Controllers
{
    public class DatabaseManagementController : Controller
    {
        ...
        public ActionResult SynchronizeData()
        {
            ...
            return RedirectToAction("SynchronizationResults", "DatabaseManagement",
                new { response.NumberOfModifications, response.NumberOfDeletions, response.OutOfSyncDocuments });
        }
